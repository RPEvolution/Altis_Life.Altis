/*
	File: fn_vehicleExperienceCfg.sqf
	Author: Spiderswine
	
	Description:
	Master configuration for vehicle experience.
*/
private["_className"];
...
switch (_className) do
{
	...
	case "B_Truck_01_medical_F": {40};
	case "B_Truck_01_Repair_F": {40};
	case "B_MRAP_01_F": {65};
	case "O_MRAP_02_F": {60};
	case "I_MRAP_03_F": {58};
	...
	case "B_Heli_Transport_03_unarmed_F": {90};
	case "B_Slingload_01_Cargo_F": {375};	
	case "I_Heli_Transport_02_F": {375};
	case "O_Heli_Transport_04_F": {90};	
	case "O_Heli_Transport_04_medevac_F": {90};	
	case "O_Heli_Transport_04_bench_F": {90};
	case "O_Heli_Transport_04_repair_F": {90};	
	case "O_Heli_Transport_04_covered_F": {375};
