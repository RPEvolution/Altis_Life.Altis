...
if(isNull _vehicle OR !(_vehicle isKindOf "Car" OR _vehicle isKindOf "Air" OR _vehicle isKindOf "Ship" OR _vehicle isKindOf "House_F" OR _vehicle isKindOf "B_Slingload_01_Cargo_F")) exitWith {}; //Either a null or invalid vehicle type.
